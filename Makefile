...
ARDUINO_DIR = /home/rs/Code/ARDUINO/arduino-1.8.15/

# Platfor.io / Rewrite Makefile due to different folder structure
#ARDUINO_DIR = /home/rs/.platformio/packages/toolchain-atmelavr/bin/
